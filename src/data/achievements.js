export const achievements = [
  {
    id: 'odoo-spit',
    title: 'Winner — Odoo × SPIT National Hackathon',
  ...
  {
    id: 'augenblick',
    title: 'Top 9 Finalist — Augenblick Hackathon',
  ...
  {
    id: 'tsec-hacks',
    title: 'Top 10 Finalist — TSECHacks Hackathon',
...
export const experience = [
  {
    ...
    description: [
      ...
      'Implemented UI/UX improvements based on user feedback and analytics',
      'Gained hands-on experience with full development lifecycle from design to deployment',
    ],
  },
];
...
export const certifications = [
  {
    ...
    issuer: 'Postman',
    link: 'https://drive.google.com/file/d/1fhgbqfqNE2b97Wpf16knrfZnpBgyollB/view?usp=sharing',
  },
  {
    title: 'Deloitte Technology Job Simulation',
    issuer: 'Deloitte',
    link: 'https://drive.google.com/file/d/1IQoYpilFZSP08tBNqACzLmV0b5Hf0S6u/view?usp=drive_link',
  }
];
